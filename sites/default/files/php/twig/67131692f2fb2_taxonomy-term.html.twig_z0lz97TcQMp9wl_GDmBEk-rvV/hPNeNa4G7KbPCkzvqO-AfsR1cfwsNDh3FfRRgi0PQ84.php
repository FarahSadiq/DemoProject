...
class __TwigTemplate_35043ed3a6edf7ff82cd37400c94a6e6 extends Template
{
  ...
  ";
        ...
        if ((($context["name"] ?? null) &&  !($context["page"] ?? null))) {
            ...
            yield "\">";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["name"] ?? null), 29, $this->source), "html", null, true);
            yield "</a></h2>
  ";
        }
        // line 31
        yield "  ";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["title_suffix"] ?? null), 31, $this->source), "html", null, true);
        yield "
  ";
        // line 32
...
";
    ...
    {
        return new Source("", "core/themes/stable9/templates/content/taxonomy-term.html.twig", "C:\\xampp\\htdocs\\drupal11\\core\\themes\\stable9\\templates\\content\\taxonomy-term.html.twig");
    }
